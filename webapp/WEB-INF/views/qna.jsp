		...
		<div class="sidebar one_quarter first">
			...
			<nav class="sdb_holder">
				<ul>
					...
					<ul>
						<li><a href="/PCos/mycomment">내 문의 보기</a></li>
			...
			<div id="comments">
				...
				<form action="#" method="post">
					<div class="two_third first">
						...
						<input type="text" name="title" id="title" value="" size="50" required>
					</div>
					<div class="one_third">
						<label for="email">Mail <span>*</span></label>
						<input type="email" name="email" id="email" size="22" required readonly>
					</div>
